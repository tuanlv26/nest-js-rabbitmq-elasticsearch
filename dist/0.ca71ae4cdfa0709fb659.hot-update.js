...
let ProductController = class ProductController {
    ...
    detailProduct(id) {
        try {
            return new globalClass_1.ResponseData(this.pro, globalEnum_1.HttpStatus.SUCCESS, globalEnum_1.HttpMessage.SUCCESS);
        }
        catch (error) {
            return new globalClass_1.ResponseData(null, globalEnum_1.HttpStatus.ERROR, globalEnum_1.HttpMessage.ERROR);
        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bcd91b4bae488542cce9")
/******/ })();
/******/ 
/******/ }
;