...
let ProductController = class ProductController {
    ...
    createProduct() {
        try {
            return new globalClass_1.ResponseData(this.productService.cr(), globalEnum_1.HttpStatus.SUCCESS, globalEnum_1.HttpMessage.SUCCESS);
        }
        catch (error) {
            return new globalClass_1.ResponseData(null, globalEnum_1.HttpStatus.ERROR, globalEnum_1.HttpMessage.ERROR);
        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("764e6d97b2379c7c432a")
/******/ })();
/******/ 
/******/ }
;