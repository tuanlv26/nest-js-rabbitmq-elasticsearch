...
let ProductController = class ProductController {
    ...
    detailProduct() {
        try {
            return new globalClass_1.ResponseData(this.productService.de(), globalEnum_1.HttpStatus.SUCCESS, globalEnum_1.HttpMessage.SUCCESS);
        }
        catch (error) {
            return new globalClass_1.ResponseData(null, globalEnum_1.HttpStatus.ERROR, globalEnum_1.HttpMessage.ERROR);
        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c76d661619f97771bc06")
/******/ })();
/******/ 
/******/ }
;